...
namespace recruitlab.server.Migrations
{
    ...
    [Migration("20260111141309_Offer letter added")]
    partial class Offerletteradded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 1, 11, 14, 13, 7, 36, DateTimeKind.Utc).AddTicks(1910),
                            Email = "admin@recruitlab.dev",
                            FirstName = "Admin",
                            LastName = "1",
                            PasswordHash = "$2a$11$G9TnJyybF8ZG0.FadgUJheJBccAXBW.BrzXOY8U4.Dd/Kd0A7zuem",
                            RoleId = 1,
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 1, 11, 14, 13, 7, 36, DateTimeKind.Utc).AddTicks(1925),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 1, 11, 14, 13, 7, 36, DateTimeKind.Utc).AddTicks(1926),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 1, 11, 14, 13, 7, 36, DateTimeKind.Utc).AddTicks(1928),
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.Interview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.InterviewAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.OfferLetter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.SkillRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.Application", b =>
                {
                    b.HasOne("Server.Model.Entities.User", "AssignedReviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.Feedback", b =>
                {
                    b.HasOne("recruitlab.server.Model.Entities.Interview", "Interview")
                        .WithMany("Feedbacks")
                        .HasForeignKey("InterviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Model.Entities.User", "Interviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.Interview", b =>
                {
                    b.HasOne("recruitlab.server.Model.Entities.Application", "Application")
                        .WithMany("Interviews")
            ...
            modelBuilder.Entity("recruitlab.server.Model.Entities.SkillRating", b =>
                {
                    b.HasOne("recruitlab.server.Model.Entities.Feedback", "Feedback")
